...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Sales_persons` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Sales_persons` (
  `idSales_persons` INT NOT NULL,
  `Name` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Invoices` (
  ...
  `Sales_persons_idSales_persons` INT NOT NULL,
  `Cars_id` INT NOT NULL,
  PRIMARY KEY (`idInvoices`, `Customers_idCustomers`, `Sales_persons_idSales_persons`, `Cars_id`),
  INDEX `fk_Invoices_Customers_idx` (`Customers_idCustomers` ASC) VISIBLE,
  INDEX `fk_Invoices_Sales_persons1_idx` (`Sales_persons_idSales_persons` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Invoices_Sales_persons1`
    ...
    REFERENCES `mydb`.`Sales_persons` (`idSales_persons`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
